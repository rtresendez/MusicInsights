...
#Standardize spelling of variables for major
...
#------------------------------------------------------------------
#This part was tricky. I manipulated the original dataframe preferences by using the gather function from Dplyr. This allowed me to lengthen data that was too wide by taking all the columns and making those rows under column name song_to_rate, then stored the ratings as keys called ratings.

preferences <- preferences %>% gather(song_to_rate, rating, 3:45)

#using this new manipulated preferences dataframe I can easily map the columns to my ratings tibble
